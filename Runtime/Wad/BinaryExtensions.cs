...
namespace Scopa.Formats
{
    ...
    public static class BinaryExtensions
    {
        ...
        {
            return new Color(br.ReadByte() / 255f, br.ReadByte() / 255f, br.ReadByte() / 255f, 1);
        }

        public static Color[] ReadRGBColourArray(this BinaryReader br, int num)
        {
            var arr = new Color[num];
            for (var i = 0; i < num; i++) arr[i] = br.ReadRGBColour();
            return arr;
        }
